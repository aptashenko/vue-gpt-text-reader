-- Run this in Supabase SQL Editor to fix the feedback table RLS policies
...
SELECT 'RLS policies updated successfully! No more auth.users references!' as status; 